    ...
    <tr>
      <td style="padding: 0 20px 20px 20px;color: #999;font-family: Arial, sans-serif;font-size: 18px;line-height: 20px;text-align:center;">
        <span style="font-family:Arial, sans-serif;font-size: 11px;color: #999;height:15px;">
           <a href="%linkDeleteSubscription%" style="color: #333;text-decoration: underline;font-size:10px;line-height:13px;">anular </a> <span style="color:#333;font-size:10px;">a subscrição da newsletter</span>
        </span>
      </td>
    </tr>
  </table>
...
`
  ...
  10: {
    ...
    subject: 'Confirmação pedido - %%ecommerceName%%',
    html: `
      <style type="text/css">
        ul {
    ...
    html: `
      <tr>
       <td style="padding: 20px 35px 20px 35px;color: #2a3a4a;font-family: Arial, sans-serif;font-size: 18px;line-height: 20px;text-align:center;">
          ...
          <span style="font-size:15px;">Olá, %firstName% %lastName%, <br><br>Temos o prazer de confirmar o seu pedido de reembolso.<br><br>Número de encomenda: %%orderNumber%%<br><br> a equipa de <a href="%%ecommerceURL%%" style="color: #2a3a4a;text-decoration:none;font-weight:bolder;"> %%ecommerceName%% </a> </span></span>
        </td>
      </tr>
    `
  }, // end 14
